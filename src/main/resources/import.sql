...
insert into contato (ID, EMAIL, TELEFONE) values (1L,'michael.thomas@outlook.com','1198455-0000');
insert into contato (ID, EMAIL, TELEFONE) values (2L,'george.alexander@outlook.com','1198000-0000');
